...
protected:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite, Category = "State", Transient, Meta = (ClampMin = 5, ClampMax = 360, ForceUnits = "deg"))
...
inline void UAlsCameraComponent::SetFOV(float NewFOV)
{
	//FMinimalViewInfo* SetViewInfo;
	 CameraFov = NewFOV;
}
